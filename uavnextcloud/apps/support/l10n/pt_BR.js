OC.L10N.register(
    ...
    "We can also provide Outlook integration, Online Office, scalable integrated audio-video and chat communication an other features only available in a limited form for free or develop further integrations and capabilities to you needs." : "Também podemos fornecer integração com o Outlook, Office Online, comunicação integrada de áudio e vídeo e bate-papo, além de outros recursos disponíveis gratuitamente apenas de forma limitada ou desenvolver integrações e recursos adicionais às suas necessidades.",
