OC.L10N.register(
    ...
    "If your server setup breaks and employees can't work anymore, you don't have to rely on searching online forums for a solution. You have direct access to our experienced engineers!" : "Si la configuración de su servidor falla y los empleados dejan de poder trabajar, no tienes que depender de búsquedas en foros en línea para encontrar la solución. Tienes acceso directo a nuestros experimentados ingenieros.",
    ...
    "We can also provide Outlook integration, Online Office, scalable integrated audio-video and chat communication an other features only available in a limited form for free or develop further integrations and capabilities to you needs." : "También podemos ofrecer integración con Outlook, ofimática en línea, comunicación escrita, de audio y de vídeo integrada y escalable y otras características que de forma gratuita están solo disponibles de forma limitada, o desarrollar más integraciones y capacidades que se necesiten.",
    "A subscription helps you get the most out of Nextcloud!" : "Una suscripción te ayuda a conseguir lo mejor de Nextcloud.",
